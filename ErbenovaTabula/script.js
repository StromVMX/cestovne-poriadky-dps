const SHEET_URL = "https://sheets.googleapis.com/v4/spreadsheets/1inuGPDSSCpBMrxxYirCa_AQ2XE3FTjvkXc_YeU_mMkQ/values/'Odjezdové panely MHD'!J4:L21?key=AIzaSyDWkH8KqIP_zg8xj-2F6SqsDXhplhSFctg";
...
async function fetchData() {
  try {
    ...
    document.getElementById('station-name').textContent = "Erbenova";
